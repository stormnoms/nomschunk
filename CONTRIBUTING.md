...
1. Create a GitHub fork of the repo you want to modify (e.g., fork `https://github.com/stormasm/nomschunk` to `https://github.com/<username>/noms`).
...
4. Create a PR using the branch you just created. Usually you can do this by just navigating to https://github.com/stormasm/nomschunk in a browser - GitHub recognizes the new branch and offers to create a PR for you.
...
See https://godoc.org/github.com/stormasm/nomschunk/go/perf/suite for full documentation and flags.
